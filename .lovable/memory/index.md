...
## Core
English only; no localization. Free-access model; no paywalls, no PayPal, no €/$ pricing anywhere.
No vendor surfaces (no vendor lists, ratings, or finnrick.com references). Booking is mailto-only.
...
## Memories
- [No paid or vendor surfaces](mem://constraints/no-paid-or-vendor-surfaces) — Hard rule: no memberships, no PayPal, no vendor lists
...
- [Consultation booking](mem://features/consultation-booking) — Mailto-only booking flow to webinars@fintiba.com, no payment
...
- [English enforcement](mem://constraints/english-only-enforcement) — Strict English-only application constraint
- [Membership automation](mem://technical/membership-automation) — DEPRECATED — membership table removed, free access for all
...
- [Access model](mem://features/access-model) — Free-access, no paywalls
