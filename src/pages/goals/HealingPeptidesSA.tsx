...
const config: GoalPageConfig = {
  ...
  title: 'Healing & Recovery Peptides South Africa — BPC-157, TB-500, GHK-Cu Research',
  description:
    'Research-grade healing peptides used in South Africa: BPC-157, TB-500, GHK-Cu and SS-31. Mechanisms, half-lives, recovery applications and SAHPRA legal status for researchers.',
  h1: 'Healing & Recovery Peptides in South Africa',
  tagline:
    'BPC-157, TB-500, GHK-Cu and SS-31 are the most-studied regenerative peptides in South African research communities. Here is what current literature shows.',
  badge: 'Healing',
  ...
  paragraphs: [
    ...
    'GHK-Cu is a copper-binding tripeptide present in human plasma that declines sharply with age. Research shows it modulates over 4,000 human genes toward a younger expression profile, stimulating collagen, glycosaminoglycan and decorin synthesis. SS-31 (elamipretide) is a mitochondria-targeted tetrapeptide that binds cardiolipin on the inner mitochondrial membrane, restoring ATP production in damaged tissue — currently in late-stage human trials for primary mitochondrial myopathy.',
  ],
  peptideIds: ['bpc157', 'tb500', 'ghkcu', 'ss31'],
};
