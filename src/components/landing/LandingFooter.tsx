import { FlaskConical, Github, Twitter, Mail } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-lg font-bold">Peptibase</span>
            </div>
            <p className="text-sm text-muted-foreground mb-4">
              Your research-grade peptide database with comprehensive scientific data.
            </p>
        ...
        <div className="mt-12 pt-8 border-t border-border/50">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
            <p>© {new Date().getFullYear()} Peptibase. All rights reserved.</p>
