...
import { GitCompare, Layers, Calculator, HelpCircle } from 'lucide-react';
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {tools.map((tool, index) => (
            ...
            >
              <Card className="h-full group hover:border-accent/50 transition-all duration-300 cursor-pointer bg-card/50 backdrop-blur-sm">
                <CardHeader>
